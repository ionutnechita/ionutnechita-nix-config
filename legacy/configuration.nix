...
let
   ...
   unstableYandexGit =
     pkgs.fetchFromGitHub {
         ...
         hash = "sha256-pRTRDcVwg8y/E+X/iAkXearc3Zc/OchzAVw0IUEP32o=";
     };
...
in
{
  ...
  nixpkgs.config = {
     ...
     permittedInsecurePackages = [
       "yandex-browser-stable-24.10.2.723-1"
       "yandex-browser-beta-24.10.2.722-1"
       "yandex-browser-corporate-24.7.6.1016-1"
     ];
     allowUnfree = true;
  };
